                    ...
                    <Paper variant="outlined" className="placeorder__order">
                        <div>
                            ...
                            <div > 
                                ...
                                <button style={{cursor:"pointer"}} className="placeorder__button addtocart" onClick={addTOCart}>Add to Cart</button>
                                
                                <Link to={"/checkout/"}>
                                    <button style={{cursor:"pointer"}} className="placeorder__button buynow">Buy Now</button>
                                </Link>
                            </div>
                        </div>
                    </Paper>
